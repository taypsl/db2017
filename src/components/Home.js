    ...
    return (
      <div className="Home">
        ...
        <div className="Body">
          ...
          <Fade delay={300} duration={6000} tag="section" className="Section section-one">
          ...
          <Fade delay={1750} duration={6000} tag="section" className="Section section-one">
          ...
          <Fade tag="section" delay={500} duration={3000} className="Section-two">
            ...
            <Fade top cascade tag="ul" delay={500} duration={3000}className="hm-text">
          ...
          <Fade tag="div" delay={500} duration={2000} className="page-navigation-home">
            <Link to="/50-21">
